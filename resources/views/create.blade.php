                ...
                <form action="" method="post">
                    <div class="flex flex-col">
                        <div class="flex flex-row items-center mt-2">
                            ...
                            <input class="bg-[#CCCCCC] py-2 rounded-md w-1/3 px-4  ml-4" type="text" placeholder="First Name">
                        </div>
                        <input class="bg-[#CCCCCC] py-2 rounded-md w-1/3 mt-2 ml-8 px-4" type="text" placeholder="Last Name">
                        <div class="flex flex-row items-center mt-2">
                            ...
                            <input class="bg-[#CCCCCC] px-2 py-2 rounded-md w-[300px] ml-4" type="number" required>
                        </div>
                        <div class="flex flex-row items-center mt-2">
                            ...
                            <input class="bg-[#CCCCCC] py-2 rounded-md w-1/3 px-4 ml-4" type="email" placeholder="Email">
                        </div>
                        <div class="flex flex-row items-center mt-2">
                            ...
                            <input class="bg-[#CCCCCC] py-2 rounded-md w-1/3 px-4 ml-4" type="text" placeholder="Category">
                        </div>
                    </div>
                </form>
            </div>
